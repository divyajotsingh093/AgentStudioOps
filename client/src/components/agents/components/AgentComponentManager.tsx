...
import { Plus, Edit, Search, ArrowUpRight, FileText, BookOpen, Database } from 'lucide-react';
import DetailedComponentView from './DetailedComponentView';
...
const AgentComponentManager: React.FC<AgentComponentManagerProps> = ({
  ...
  // Handle component click to show detailed view
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      {showDetailView && selectedComponent ? (
        // Show the detailed view when a component is selected
                        ...
                        <div className="flex justify-between items-start flex-wrap">
                          <CardTitle className="text-md font-semibold flex items-center">
                            ...
                            {component.type?.includes('Lab') && (
                              <BookOpen className="h-4 w-4 ml-2 text-amber-600" />
                            )}
                            {component.type?.includes('Benefit') && (
                              <Database className="h-4 w-4 ml-2 text-teal-600" />
                            )}
                          </CardTitle>
