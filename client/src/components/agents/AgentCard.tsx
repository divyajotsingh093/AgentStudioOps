...
const getAgentTypeColor = (type: string) => {
  switch (type) {
    case 'UW':
      return "bg-neutrinos-blue/10 text-neutrinos-blue";
    case 'Claims':
      ...
      <div className="agent-card bg-white rounded-xl shadow-md p-5 cursor-pointer">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center">
            <div className="h-10 w-10 bg-neutrinos-blue/10 rounded-lg flex items-center justify-center">
              <AgentIcon className="h-5 w-5 text-neutrinos-blue" />
            </div>
            <div className="ml-3">
